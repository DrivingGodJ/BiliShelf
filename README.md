...
<img width="2241" height="1261" alt="18740ef2e2bfbce9b416600e767fd77b" src="https://github.com/user-attachments/assets/d7fc93a0-836a-4273-a204-ece600cca48c" />
...
- AI 整理：可按范围和自然语言要求生成分类方案，确认后事务性应用，并支持快照与撤销
- 专栏收藏：支持在 B 站专栏页面收藏内容，并使用独立于视频收藏夹的专栏文件夹进行管理
- 评论收藏：支持在视频页、稍后再看页面和专栏页面收藏评论，包括评论图片和原评论链接
...
- 收藏动作监听：默认开启，可监听 B 站收藏动作，并自动对账到本地
...
2. AI 整理功能
3. 专栏收藏功能
4. 评论收藏功能（覆盖视频页、稍后再看页面、专栏页面）
5. 定期备份提醒
6. 更新检查

已优化：

1. 优化运行速度，以及视频同步、标签同步效率
2. 优化整体 UI/UX
3. 监听设置默认开启

已修复：

1. 修复收藏夹区域和视频区域一起滚动而不是分开滚动的问题
